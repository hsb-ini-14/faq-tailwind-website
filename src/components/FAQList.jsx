      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
        ...
        <div className="flex items-center space-x-4">
          <button
            ...
            onClick={toggelExpandAll}
          >
            <i
              className={`bx ${
                expandAll ? "bx-shrink-right" : "bx-expand-right"
              } text-lg`}
            ></i>
          ...
          <button
            ...
            className="w-10 h-10 flex items-center justify-center rounded-full bg-gradient-to-r from-gray-200 to-gray-300 text-gray-700 dark:text-gray-200 dark:from-gray-700 dark:to-gray-800 hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 transition-all duration-300 cursor-pointer"
          >
