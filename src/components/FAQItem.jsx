...
const FAQItem = ({ item, onClick, isOpen }) => {
  ...
  return (
    ...
    >
      <button
        className={`w-full py-5 px-4 flex items-center justify-between text-left focus:outline-none rouinded-lg transition-all duration-200 cursor-pointer ${
          isOpen
      ...
      >
        ...
        >
          <i
            className={`"bx bx-${isOpen ? "minus" : "plus"} ${
